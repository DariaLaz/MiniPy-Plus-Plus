...
const std::vector<
    std::function<std::shared_ptr<Builtin>()>>
    builtins = {
        make_builtin<LenBuiltin>,
        make_builtin<RangeBuiltin>,
        make_builtin<PrintBuiltin>,
        make_builtin<AppendBuiltin>,
        make_builtin<StrBuiltin>,
        make_builtin<IntBuiltin>};
